...
"""
The original library was developed by Mark Silliman.
It was picked from URX repository, with little modification for adaptation to Universal Robots e series.
